...
namespace UnitTest
{
    ...
    public class EcmaLoaderDocsTests
    {
        ...
        [TestMethod]
        public void LoadDocs_RemarksWithExampleCode()
        {
            var comments = XElement.Parse(
            @"<Docs>
            ...
            var expectedRemarks = "<p>The following example shows the creation of a ScrollView with a large <xref data-throw-if-not-resolved=\"true\" uid=\"Xamarin.Forms.StackLayout\"></xref> in it.</p><p><div> "
            + Environment.NewLine + "\n```csharp lang-csharp\nvar stack = new StackLayout();\n\nfor (int i = 0; i < 100; i++)\n{\n    stack.Children.Add(new Button { Text = 'Button ' + i\n});\n}\n\nMainPage = new ContentPage\n{\n    Content = new ScrollView { Content = stack }\n};\n```"
            + Environment.NewLine + " </div> <block type=\"note\">Application developers should not nest one <xref data-throw-if-not-resolved=\"true\" uid=\"Xamarin.Forms.ScrollView\"></xref> within another. Additionally, they should refrain from nesting them  other elements that can scroll, such as <xref data-throw-if-not-resolved=\"true\" uid=\"Xamarin.Forms.WebView\"></xref>.</block></p><p><img src=\"~/Xamarin.Forms/_images/ScrollView.TripleScreenShot.png\" /></p>";

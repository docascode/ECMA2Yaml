"./ECMA2Yaml/ECMA2Yaml/bin/Release/ECMA2Yaml.exe" -s ./test/xml -o ./test/yml_MREF_After -f
"./ECMA2Yaml/ECMA2Yaml/bin/Release/ECMA2Yaml.exe" -s ./test/xml -o ./test/yml_SDP_After --SDP -f
